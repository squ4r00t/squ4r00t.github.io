...
mermaid: true
image:
  path: /assets/img/general/pscan_through_pivots/tn.png
---
...
![Pivoting Scenario](/assets/img/general/pscan_through_pivots/pivoting_primer.png)
_Basic Pivoting Scenario_
...
![](/assets/img/general/pscan_through_pivots/old_way.png)
_Scanning through a pivot (default way)_
...
> The command that is executed and whether a HTTP server or SMB share should be setup depends on the OS of the host perfoming the scan. This is explained in [sps' README](https://github.com/squ4r00t/sps).

Once the binary is retrieved it will be executed in memory and the results will be returned on STDOUT.

![](/assets/img/general/pscan_through_pivots/tn.png)
_Port scanning through pivot using sps_
